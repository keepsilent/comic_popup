...
gulp.task('create', function () {
    ...
    gulp.src(['./dist/images/*','./dist/images/**/*.jpg','./dist/images/**/*.png','./dist/images/**/*.gif']).pipe(gulp.dest(path+'/images')).pipe(notify('images lib create completed'));
    gulp.src(['./dist/css/*.css']).pipe(minify()).pipe(gulp.dest(path+'/css')).pipe(notify('css lib create completed'));
    gulp.src(['./dist/js/lib/**/*.js']).pipe(uglify()).pipe(gulp.dest(path+'/js/lib')).pipe(notify('js lib create completed'));
    gulp.src(['./dist/js/*.js']).pipe(uglify()).pipe(gulp.dest(path+'/js')).pipe(notify('js create completed'));
});
