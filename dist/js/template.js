...
template('dist/template/favor/nothing','<div class="ddl-comic-favor-nothing"> <p class="iconfont icon-meiyoushu"></p> <p>Σ(ﾟдﾟ;) 书架空空～</p> </div>');/*v:1*/
...
template('dist/template/search/loading','<div class="ddl-loading-spinner" style="margin-left: -55px;font-size: 60px;"> <div class="rect1"></div> <div class="rect2"></div> <div class="rect3"></div> <div class="rect4"></div> <div class="rect5"></div> </div>');/*v:1*/
template('dist/template/search/nothing','<div class="ddl-comic-favor-nothing"> <p class="iconfont icon-meiyoushu" style="margin-top:10%;"></p> <p style="margin-top:20px;">Σ(ﾟдﾟ;) 没有搜索到～</p> </div>');/*v:1*/
